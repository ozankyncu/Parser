...
public class ReadXmlDocument {
    ...
    public static Documents printNodebyDocumentClass(NodeList document_list)
    {
        ...
        Node[] isbns = new Node[length];
        Node[] issns = new Node[length];
        Node[] article_titles = new Node[length];
        Node[] article_dois = new Node[length];
        ...
        for (int count = 0; count < document_list.getLength(); count++) {
            ...
            if (tempNode.getNodeType() == Node.ELEMENT_NODE) {
                ...
                //isbns[count] = parser.getNode("isbn",tempNode.getChildNodes());
                //issns[count] = parser.getNode("issn",tempNode.getChildNodes());
                article_titles[count] = parser.getNode("title",tempNode.getChildNodes());
                article_dois[count] = parser.getNode("doi",tempNode.getChildNodes());
        ...
        for (int i = 0; i < document_list.getLength() ; i++) {
            ...
            article.setDoi(article_dois[i].getTextContent());
//            article.setIsbn(isbns[i].getTextContent());
//            article.setIssn(issns[i].getTextContent());
            article.setArticle_title(article_titles[i].getTextContent());
